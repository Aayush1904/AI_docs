...
-- CreateEnum
CREATE TYPE "IndexingStatus" AS ENUM ('pending', 'in_progress', 'completed', 'failed');
...
-- CreateIndex
CREATE INDEX "Comment_commitId_idx" ON "Comment"("commitId");
...
-- AddForeignKey
ALTER TABLE "Comment" ADD CONSTRAINT "Comment_commitId_fkey" FOREIGN KEY ("commitId") REFERENCES "Commit"("id") ON DELETE SET NULL ON UPDATE CASCADE;
