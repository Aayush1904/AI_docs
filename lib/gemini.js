...
\n\n${diff}`;
  ...
  // Remove or correct this log; use 'result' not 'response'
  // console.log("Full AI response:", response);

  // Optionally, check if the expected property exists:
  if (
    !result ||
    !result.response ||
...
export async function summariseCode(doc) {
  console.log("getting summary for", doc.metadata.source);

  try {
    // Extract the code content while ensuring it doesn't exceed 10,000 characters
